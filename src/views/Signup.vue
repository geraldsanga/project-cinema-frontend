  ...
  <div class="wrapper">
    <div style="margin-top: 200px">
      <div class="row">
        <div class="col">
            <form class="form-signin">
              <h1 class="h3 mb-3 font-weight-normal text_color">Please Register</h1>
              <label for="inputEmail" class="sr-only mb-3">Username</label>
              <input type="text" id="inputEmail" class="form-control mb-3" placeholder="Username" required autofocus>
      ...
      <div class="col align-self-center">
        <p class="text_color">Alread have an account? <router-link :to="{ name: 'Login' }">Signin</router-link></p>
      </div>
    </div>
    </div>
  </div>
